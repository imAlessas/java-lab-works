    ...
    private static void testAccount(BankAccount a)
    {
        ...
        */
        ...
        if(a instanceof TimeDepositAccount){
            TimeDepositAccount tda = (TimeDepositAccount)a;
            tda.addInterest();
            System.out.println("Mancano " + tda.getTimeDeposit() + " mesi prima di poter prelevare.");
            newa = new TimeDepositAccount(tda.getBalance(), tda.getInterestRate(), tda.getTimeDeposit());
        }
